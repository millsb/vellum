...
export interface RootQueryType {
  ...
  allMainNavYaml?: MainNavYamlConnection | null; /* Connection to all MainNavYaml nodes */
...
export interface File extends Node {
  ...
  childrenMainNavYaml?: MainNavYaml[] | null; /* The children of this node of type mainNavYaml */
...
/* Node of type MainNavYaml */
export interface MainNavYaml extends Node {
  id: string; /* The id of this node. */
  parent?: Node | null; /* The parent of this node. */
  children?: Node[] | null; /* The children of this node. */
  label?: string | null; 
...
/* A connection to a list of items. */
export interface MainNavYamlConnection {
  pageInfo: PageInfo; /* Information to aid in pagination. */
  edges?: MainNavYamlEdge[] | null; /* A list of edges. */
  totalCount?: number | null; 
  distinct?: string[] | null; 
  group?: mainNavYamlGroupConnectionConnection[] | null; 
}
/* An edge in a connection. */
export interface MainNavYamlEdge {
  node?: MainNavYaml | null; /* The item at the end of the edge */
  next?: MainNavYaml | null; /* The next edge in the connection */
  previous?: MainNavYaml | null; /* The previous edge in the connection */
}
/* A connection to a list of items. */
export interface mainNavYamlGroupConnectionConnection {
  pageInfo: PageInfo; /* Information to aid in pagination. */
  edges?: mainNavYamlGroupConnectionEdge[] | null; /* A list of edges. */
  field?: string | null; 
  fieldValue?: string | null; 
  totalCount?: number | null; 
}
/* An edge in a connection. */
export interface mainNavYamlGroupConnectionEdge {
  node?: MainNavYaml | null; /* The item at the end of the edge */
  next?: MainNavYaml | null; /* The next edge in the connection */
  previous?: MainNavYaml | null; /* The previous edge in the connection */
}
...
export interface mainNavYamlConnectionSort {
  fields: MainNavYamlConnectionSortByFieldsEnum[]; 
  order?: mainNavYamlConnectionSortOrderValues | null; 
}
/* Filter connection on its fields */
export interface filterMainNavYaml {
  label?: mainNavYamlConnectionLabelQueryString_2 | null; 
  href?: mainNavYamlConnectionHrefQueryString_2 | null; 
  id?: mainNavYamlConnectionIdQueryString_2 | null; 
  internal?: mainNavYamlConnectionInternalInputObject_2 | null; 
}

export interface mainNavYamlConnectionLabelQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlConnectionHrefQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlConnectionIdQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlConnectionInternalInputObject_2 {
  contentDigest?: mainNavYamlConnectionInternalContentDigestQueryString_2 | null; 
  type?: mainNavYamlConnectionInternalTypeQueryString_2 | null; 
  owner?: mainNavYamlConnectionInternalOwnerQueryString_2 | null; 
}

export interface mainNavYamlConnectionInternalContentDigestQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlConnectionInternalTypeQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlConnectionInternalOwnerQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlLabelQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlHrefQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlIdQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlInternalInputObject_2 {
  contentDigest?: mainNavYamlInternalContentDigestQueryString_2 | null; 
  type?: mainNavYamlInternalTypeQueryString_2 | null; 
  owner?: mainNavYamlInternalOwnerQueryString_2 | null; 
}

export interface mainNavYamlInternalContentDigestQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlInternalTypeQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface mainNavYamlInternalOwnerQueryString_2 {
  eq?: string | null; 
  ne?: string | null; 
  regex?: string | null; 
  glob?: string | null; 
...
export interface AllMainNavYamlRootQueryTypeArgs {
  skip?: number | null; 
  limit?: number | null; 
  sort?: mainNavYamlConnectionSort | null; 
  filter?: filterMainNavYaml | null; 
}
...
export interface MainNavYamlRootQueryTypeArgs {
  label?: mainNavYamlLabelQueryString_2 | null; 
  href?: mainNavYamlHrefQueryString_2 | null; 
  id?: mainNavYamlIdQueryString_2 | null; 
  internal?: mainNavYamlInternalInputObject_2 | null; 
}
...
export interface DistinctMainNavYamlConnectionArgs {
  field?: mainNavYamlDistinctEnum | null; 
}
export interface GroupMainNavYamlConnectionArgs {
  skip?: number | null; 
  limit?: number | null; 
  field?: mainNavYamlGroupEnum | null; 
}
...
export type SitePageConnectionSortByFieldsEnum = "layout" | "jsonName" | "internalComponentName" | "path" | "matchPath" | "component" | "componentChunkName" | "context" | "updatedAt" | "pluginCreator___NODE" | "pluginCreatorId" | "componentPath" | "id" | "parent" | "children" | "internal___type" | "internal___contentDigest" | "internal___owner";


export type sitePageConnectionSortOrderValues = "ASC" | "DESC";


export type sitePageDistinctEnum = "layout" | "jsonName" | "internalComponentName" | "path" | "component" | "componentChunkName" | "context" | "updatedAt" | "pluginCreator___NODE" | "pluginCreatorId" | "componentPath" | "id" | "parent" | "internal___type" | "internal___contentDigest" | "internal___owner";


export type sitePageGroupEnum = "layout" | "jsonName" | "internalComponentName" | "path" | "component" | "componentChunkName" | "context" | "updatedAt" | "pluginCreator___NODE" | "pluginCreatorId" | "componentPath" | "id" | "parent" | "internal___type" | "internal___contentDigest" | "internal___owner";
...
export type MarkdownRemarkConnectionSortByFieldsEnum = "id" | "children" | "parent" | "internal___content" | "internal___contentDigest" | "internal___type" | "internal___owner" | "frontmatter___title" | "frontmatter____PARENT" | "frontmatter___parent" | "fileAbsolutePath" | "html" | "excerpt" | "headings" | "timeToRead" | "tableOfContents" | "wordCount___paragraphs" | "wordCount___sentences" | "wordCount___words";


export type markdownRemarkConnectionSortOrderValues = "ASC" | "DESC";


export type markdownRemarkDistinctEnum = "id" | "parent" | "internal___content" | "internal___contentDigest" | "internal___type" | "internal___owner" | "frontmatter___title" | "frontmatter____PARENT" | "frontmatter___parent" | "fileAbsolutePath";


export type markdownRemarkGroupEnum = "id" | "parent" | "internal___content" | "internal___contentDigest" | "internal___type" | "internal___owner" | "frontmatter___title" | "frontmatter____PARENT" | "frontmatter___parent" | "fileAbsolutePath";


export type MainNavYamlConnectionSortByFieldsEnum = "label" | "href" | "id" | "children" | "parent" | "internal___contentDigest" | "internal___type" | "internal___owner";


export type mainNavYamlConnectionSortOrderValues = "ASC" | "DESC";


export type mainNavYamlDistinctEnum = "label" | "href" | "id" | "parent" | "internal___contentDigest" | "internal___type" | "internal___owner";


export type mainNavYamlGroupEnum = "label" | "href" | "id" | "parent" | "internal___contentDigest" | "internal___type" | "internal___owner";
